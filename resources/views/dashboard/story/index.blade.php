            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="{{ route('story.create') }}" class="btn btn-primary pull-right">Add New</a>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <form action="" method="POST" id="deleteStoryForm">
                                    @csrf
                                    @method('DELETE')
...
@section('scripts')
    ...
    <script>
        function handleDelete(id) {
            let form = document.getElementById('deleteStoryForm');
            form.action = '/story/' + id;
