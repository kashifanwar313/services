...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Driveway Price Sheet</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Driveway Price Sheet</h3>
                        <a href="{{ route('driveway.price.sheet.create') }}" class="btn btn-primary pull-right">Add New</a>
                    </div>
                    ...
                    <div class="box-body">
                            ...
                            <tbody>
                                @foreach ($price_sheets as $price_sheet)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('driveway.price.sheet.edit', [$price_sheet]) }}"
                        ...
                        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <form action="" method="POST" id="deleteDrivewayPriceSheetForm">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel">Delete Driveway Price Sheet</h5>
                                        ...
                                        <div class="modal-body">
                                            Are you sure you want to delete this Driveway Price Sheet?
                                        </div>
...
@section('scripts')
    ...
    <script>
        function handleDelete(id) {
            let form = document.getElementById('deleteDrivewayPriceSheetForm');
            form.action = '/driveway-price-sheet/' + id;
